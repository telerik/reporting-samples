...
CustomResourceResolver.Configuration.Instance.Init(reportsPath, Path.Combine(reportsPath, "Resources"));
...
// This step is not mandatory and is added for demonstration purposes only.
CustomSharedDataSourceResolver.Configuration.Instance.Init(reportsPath, Path.Combine(reportsPath, "Shared Data Sources"));
